...
void exercise5() {
	...
	*/
	...
	std::cin >> name;
	if (name == "Moritz") {
		std::cout << "Geh bitte weg!" << std::endl;
	}
	else {
	...
	int time;
	std::cout << "Wie spät ist es?" << std::endl;
	std::cin >> time;
	if (time < 6) {
		std::cout << "Gute Nacht " << name << std::endl;
	}
	else if (time < 11) {
		std::cout << "Guten Morgen " << name << std::endl;
	}
	else if (time < 22) {
		std::cout << "Guten Tag " << name << std::endl;
	}
	else if (time < 24) {
		std::cout << "Gute Nacht " << name << std::endl;
	}
	else {
		std::cout << "Damit kann ich nichts anfangen" << std::endl;
	}
